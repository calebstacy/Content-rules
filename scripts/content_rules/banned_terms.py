...
def evaluate(rule: dict[str, Any], artifact: dict[str, Any]) -> dict[str, Any]:
    ...
    if failures:
        return {**base, "status": "FAIL", "message": "Configured banned terminology was found.", "evidence": failures, "review_evidence": reviews}
    if reviews:
        return {**base, "status": "REVIEW", "message": "The configured scope was missing or was not text.", "evidence": [], "review_evidence": reviews}
    return {**base, "status": "PASS", "message": "No configured banned terminology was found.", "evidence": [], "review_evidence": []}
